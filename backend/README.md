...
## Project Structure
    ...
    ├── nameless_silence_de_95219  # Django project configurations
...
1. Clone this repo and `cd nameless_silence_de_95219`
...
2. Clone this repo and `cd nameless_silence_de_95219`
